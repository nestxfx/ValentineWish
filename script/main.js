...
const animationTimeline = () => {
  ...
  // PERSIAN FIX: We split by " " (space) instead of "" (empty) 
  // to keep Persian letters connected within words.
  ...
  tl.to(".container", 0.1, {
    ...
    .staggerTo(
      ...
      0.5,
      { visibility: "visible" },
      0.1 // Slightly slower stagger since it's words now
    )
    ...
    .to(".idea-3 strong", 0.5, {
      scale: 1.2,
      x: -10, // Changed to negative for RTL flow
